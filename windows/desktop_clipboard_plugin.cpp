#include "include/desktop_clipboard/desktop_clipboard_plugin.h"
...
void DesktopClipboardPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  DesktopClipboardPlugin::RegisterWithRegistrar(
